...
This repository uses a simple template for new CMake projects.
...
* Several commonly used directories like `.vs/`, `out/` and `build/`.
...
If you want to clone a local copy of the repository, put it inside a `lib/Catch2/` directory at the root of the project. The template will detect it automatically.
